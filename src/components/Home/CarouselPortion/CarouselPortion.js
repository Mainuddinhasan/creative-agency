...
const CarouselPortion = () => {
    return (
            ...
            height: '100%', background: '#111430',backgroundSize: 'cover'
                ...
                <img style={{width: '470px', height: '400px', padding: '50px'}}src={img1} alt=""/>  
                <img style={{width: '470px', height: '400px', padding: '50px'}}src={img2} alt=""/>  
                <img style={{width: '470px', height: '400px',padding: '50px'}}src={img3} alt=""/>  
                <img style={{width: '470px', height: '400px',padding: '50px'}}src={img4} alt=""/>  
                <img style={{width: '470px', height: '400px', padding: '50px'}}src={img5} alt=""/>  
...
export default CarouselPortion;